...
export function AgentConfigForm(props: AgentConfigFormProps) {
  ...
  const createSecret = useMutation({
    mutationFn: (input: { name: string; value: string }) => {
      if (!selectedCompanyId) throw new Error("Select a research project to create secrets");
  ...
  const {
    ...
    queryFn: () => {
      if (!selectedCompanyId) {
        throw new Error("Select a research project to detect the model");
      }
  ...
  const testEnvironment = useMutation({
    mutationFn: async () => {
      if (!selectedCompanyId) {
        throw new Error("Select a research project to test adapter environment");
      }
